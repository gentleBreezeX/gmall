...
public class AttrAttrgroupRelationController {
    ...
    @ApiOperation("删除关联关系")
    public Resp<String> removeAttrRelationByAttrIdAndAttrGroupId(
            @RequestBody List<AttrAttrgroupRelationEntity> relations){

        attrAttrgroupRelationService.removeAttrRelationByAttrIdAndAttrGroupId(relations);
