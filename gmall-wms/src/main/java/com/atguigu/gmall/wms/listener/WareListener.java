...
public class WareListener {
    ...
    public void unlock(String orderToken) {
        ...
        //遍历解锁库存
        skuLockVOS.forEach(skuLockVO -> this.wareSkuDao.unLockStore(skuLockVO.getSkuWareId(),skuLockVO.getCount()));
    ...
    public void minusStock(String orderToken) {
        ...
        //遍历解锁库存
        skuLockVOS.forEach(skuLockVO -> this.wareSkuDao.minus(skuLockVO.getSkuWareId(),skuLockVO.getCount()));
        this.redisTemplate.delete("order:stock:" + orderToken);
